...
export const YouTubeIcon = (p) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
    <path d="M22.5 7.2a2.9 2.9 0 0 0-2-2C18.7 4.7 12 4.7 12 4.7s-6.7 0-8.5.5a2.9 2.9 0 0 0-2 2A30.6 30.6 0 0 0 1 12a30.6 30.6 0 0 0 .5 4.8 2.9 2.9 0 0 0 2 2c1.8.5 8.5.5 8.5.5s6.7 0 8.5-.5a2.9 2.9 0 0 0 2-2A30.6 30.6 0 0 0 23 12a30.6 30.6 0 0 0-.5-4.8ZM9.8 15.5v-7l6 3.5-6 3.5Z" />
  </svg>
)
